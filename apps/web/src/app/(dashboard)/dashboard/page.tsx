...
export default async function DashboardPage() {
  ...
  return (
    <div className="flex-1 space-y-6 p-8 max-w-7xl mx-auto w-full">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="border-border/40">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Firm associates enrolled</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-border/40">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Biometric + Remote Check-in</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-border/40">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Salaries & subscriptions</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-border/40">
          ...
          <CardContent>
            <div className="text-sm font-mono truncate">{user.firmId || "Platform Admin"}</div>
            <p className="text-xs text-muted-foreground">Isolated firm boundary</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="border-border/40">
        <CardHeader>
          <CardTitle className="text-base">Server-Side Session Info (SSR)</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-2 font-mono text-xs">
          ...
          <div className="grid grid-cols-3 gap-2 p-2 bg-muted/40 rounded">
            <span className="font-semibold text-muted-foreground">Firm ID:</span>
